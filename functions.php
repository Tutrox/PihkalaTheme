...
function styleLoader() {
  wp_enqueue_style('pihkala-style', 'https://cdn.jsdelivr.net/gh/Tutrox/PihkalaStyles@1.0.0/build/pihkala.min.css', array(), null);
  wp_enqueue_script('pihkala-js', 'https://cdn.jsdelivr.net/combine/gh/Tutrox/jqc@1.0.0/jqc.js,npm/bootstrap@4.0.0-beta.2/dist/js/bootstrap.bundle.min.js', array('jquery'), null);
